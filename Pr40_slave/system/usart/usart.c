...
//внешний тактовый генератор 80ћгц  на TMR8 подаетс€ 80ћ√÷/2 + делитель 256. 
// “.е увеличение TMR8 на 1 происходит раз в (1/80ћгц)*256= раз в 6,4мкс
//поэтому после включени€ таймера пройдет период 300мкс/6.4мкс=47 и выставитс€ флаг IFS3bits.T8IF
{
	unsigned char data;
		
	
	data=U1RXREG;  //сдвиговый RX буфер дл€ USART, имеет размер 4 байта
